...
from .models import PreFlourishBooking, PreFlourishWorkList, PreFlourishLogEntry, PreFlourishInPersonContactAttempt
...
class AppointmentRegistrationForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_action = 'pre_flourish_follow:flourish_follow_book_listboard_url'
...
class AppointmentsWindowForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_action = 'pre_flourish_follow:flourish_follow_appt_listboard_url'
        self.helper.form_class = 'form-inline'
        self.helper.field_template = 'bootstrap3/layout/inline_field.html'
        self.helper.layout = Layout(
            'start_date',
...
class SingleReAssignParticipantForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_action = 'pre_flourish_follow:home_url'
        self.helper.form_class = 'form-inline'
        self.helper.layout = Layout(
            'reassign_name',
            'username_from',
...
class ParticipantsNumberForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_action = 'pre_flourish_follow:flourish_follow_listboard_url'
...
class InPersonContactAttemptForm(
    ...
    class Meta:
        model = PreFlourishInPersonContactAttempt
        fields = '__all__'
