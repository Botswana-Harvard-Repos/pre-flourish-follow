...
class AppointmentListboardView(NavbarViewMixin, EdcBaseViewMixin,
    ...
    listboard_template = 'pre_flourish_follow_appt_listboard_template'
    listboard_url = 'pre_??????flourish_follow_appt_listboard_url'
    ...
    ordering = '-modified'
    paginate_by = 10
    search_form_url = 'pre_flourish_follow_appt_listboard_url'
    filter = None
    ...
    def get_success_url(self):
        return reverse('pre_flourish_follow:flourish_follow_appt_listboard_url')
