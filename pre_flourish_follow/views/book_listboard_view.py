...
class BookListboardView(NavbarViewMixin, EdcBaseViewMixin,
    ...
    listboard_template = 'pre_flourish_follow_book_listboard_template'
    listboard_url = 'pre_flourish_follow_book_listboard_url'
    ...
    ordering = '-modified'
    paginate_by = 10
    search_form_url = 'pre_flourish_follow_book_listboard_url'

    def get_success_url(self):
        return reverse('pre_flourish_follow:flourish_follow_book_listboard_url')
    ...
    def get_context_data(self, **kwargs):
        ...
        booked_tomorrow = PreFlourishBooking.objects.filter(
