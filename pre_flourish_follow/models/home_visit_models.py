...
from .worklist import PreFlourishWorkList


class PreFlourishInPersonLog(BaseUuidModel):
...
class PreFlourishInPersonContactAttempt(BaseUuidModel):

    in_person_log = models.ForeignKey(
        PreFlourishInPersonLog,
        on_delete=PROTECT,  related_name='pre_flourish_inpersonlog')
